...
import { Code, Briefcase,Shield,SquarePi,Brain,Box, Snowflake,Divide, Rotate3D,History,BrainIcon, Apple, GraduationCap, BookOpen } from 'lucide-react'
...

        {
            ...
            text: (
                <a 
                    ...
                    className="text-purple-500 hover:underline"
                >
                 [07 May 2024] Published in PRD: Gravitational atoms in the braneworld scenario.
                </a>
            ),
        },
