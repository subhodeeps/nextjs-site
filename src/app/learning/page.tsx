        ...
        <>
            <BaseContainer size="md" paddingX="md" paddingY="lg">
                <StackVertical gap="md">
                    ...
                    <Text variant="muted" className="mb-8">
                        Most of the stuff listed here is hosted on a separate <Link href="https://just-the-notes.vercel.app/" className="text-purple-500 font-bold hover:underline">project/repository</Link> because [a] I wanted to keep using other tools to make sites, [b] I wanted to implement a roam-research like workspace based on the principle of <i>Zettelkasten</i> and [c] I failed to make markdown and KaTeX work over here. 
                    </Text>
